  ...
  return (
    <section className="main-page__banner banner">
      <div className="container banner__container">
        <h2 className="banner__title">Make your pet’s life better</h2>
        <div className="banner__for-pets">
          <ForPetShortButton
            isCat={true}
            className={isCatHovered ? 'hover' : ''}
          />
